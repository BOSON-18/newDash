...
const GenericForm = () => {
  ...
  const [defaultDate, setDefaultDate] = useState("2023-03-13");
  ...
  useEffect(() => {
    ...
    categoryFetch();
    const lowDate="2023-03-13";
    const highDate="2023-03-13";
    onSubmit({date:lowDate,lowDate:lowDate,highDate:highDate});
  }, []);
